...
public class GoodsDAO extends BaseDao {
	...
	public static final String NUM_PER_SERVING = "numPerServing";
	...
	public Goods findById(java.lang.Integer id) {
		...
		try {
			Goods instance = (Goods) getSession().get("baking.model.Goods", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Goods instance) {
		...
		try {
			List results = getSession().createCriteria("baking.model.Goods")
	...
	public List findByNumPerServing(Object numPerServing) {
		return findByProperty(NUM_PER_SERVING, numPerServing);
	}
